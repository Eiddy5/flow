...
docs/
  ...
  uc/           # Pre-implementation acceptance contracts derived from confirmed requirements and architecture
...
- `docs/uc/`: Store pre-implementation UC acceptance contracts derived only from confirmed requirements and effective architecture design. Each UC should include source traceability, positive, negative, and mutation scenarios, verification methods, and pass rules. Production code and tests must consume UC expectations and must not redefine them; execution evidence and counterexamples belong in `docs/test-reports/`.
...
6. Use `docs/uc/` to choose the UC scenarios, verification methods, and pass rules for the change.
