...
public class DoubleInput extends Input<Double> {
     ...
     * @return 已完成定义校验的 DoubleInput
     * @throws IllegalArgumentException 当字段类型或完整定义非法时抛出
     */
    @JsonCreator
    public static DoubleInput from(
        ...
        return new DoubleInput(
            ...
            defaultValue == null ? null : (Double) DataType.DOUBLE.normalize(defaultValue)
        );
    }
    ...
    protected Double convert(Object value) {
        return (Double) DataType.DOUBLE.normalize(value);
    }
