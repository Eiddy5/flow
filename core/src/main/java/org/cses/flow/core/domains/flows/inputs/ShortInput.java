...
public class ShortInput extends Input<Short> {
    ...
    protected Short convert(Object value) {
        return (Short) DataType.SHORT.normalize(value);
    }
}
