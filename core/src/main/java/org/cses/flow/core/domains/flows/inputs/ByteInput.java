...
public class ByteInput extends Input<Byte> {
     ...
     * @return 已完成定义校验的 ByteInput
     * @throws IllegalArgumentException 当字段类型或完整定义非法时抛出
     */
    @JsonCreator
    public static ByteInput from(
        ...
        return new ByteInput(
            ...
            defaultValue == null ? null : (Byte) DataType.BYTE.normalize(defaultValue)
        );
    }
    ...
    protected Byte convert(Object value) {
        return (Byte) DataType.BYTE.normalize(value);
    }
}
