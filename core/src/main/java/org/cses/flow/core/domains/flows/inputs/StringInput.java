...
public class StringInput extends Input<String> {
     ...
     * @return 已完成定义校验的 StringInput
     * @throws IllegalArgumentException 当字段类型或完整定义非法时抛出
     */
    @JsonCreator
    public static StringInput from(
        ...
        return new StringInput(
            ...
            defaultValue == null ? null : (String) DataType.STRING.normalize(defaultValue)
        );
    }
