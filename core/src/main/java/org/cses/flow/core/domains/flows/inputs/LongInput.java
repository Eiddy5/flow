...
public class LongInput extends Input<Long> {
     ...
     * @return 已完成定义校验的 LongInput
     * @throws IllegalArgumentException 当字段类型或完整定义非法时抛出
     */
    @JsonCreator
    public static LongInput from(
        ...
        return new LongInput(
            ...
            defaultValue == null ? null : (Long) DataType.LONG.normalize(defaultValue)
        );
    }
    ...
    protected Long convert(Object value) {
        return (Long) DataType.LONG.normalize(value);
    }
}
