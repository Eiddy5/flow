...
公开 `inScope` 接口及清理方式曾由 ADR 0091 隐藏；现由
[ADR 0097](0097-carry-lock-in-aggregate-and-inherit-cas-repository.md) 删除作用域与缓存，
改为对象携带 lock，业务继续使用普通 `find/save`。以下保留原决策背景。
