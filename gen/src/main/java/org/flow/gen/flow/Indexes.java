...
public class Indexes {
    ...
    public static final Index UQ_FLOWS_DEPLOYED_KEY_REVERSION = Internal.createIndex(DSL.name("uq_flows_deployed_key_reversion"), FlowsTable.FLOWS, new OrderField[] { FlowsTable.FLOWS.COMPANY_ID, FlowsTable.FLOWS.KEY, FlowsTable.FLOWS.VERSION }, true);
